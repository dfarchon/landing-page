        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-16">
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 mb-6 max-w-md">
              ...
              <br />
              The prototype of onchain reality universe.
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://discord.gg/XpBPEnsvgX" className="text-white/60 hover:text-primary transition-colors">
              ...
              <Link href="https://github.com/dfarchon" className="text-white/60 hover:text-primary transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-white/70 hover:text-primary transition-colors cursor-pointer bg-transparent border-none"
                >
                  Enter Game
                </button>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://github.com/dfarchon" className="text-white/70 hover:text-primary transition-colors">
                  GitHub
                </Link>
              </li>
              <li>
                <Link href="https://www.youtube.com/@dfarchon1759" className="text-white/70 hover:text-primary transition-colors">
                  Youtube
                </Link>
              </li>
              <li>
                <Link href="https://mirror.xyz/dfarchon.eth" className="text-white/70 hover:text-primary transition-colors">
                  Mirror Blog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://discord.gg/XpBPEnsvgX"
                  className="bg-secondary text-white py-1 px-3 rounded-md hover:bg-secondary-light transition-colors inline-block cursor-pointer border-none"
                >
                  Support Center
                </Link>
              </li>
              <li>
                <Link href="mailto:dfarchon@gmail.com" className="text-white/70 hover:text-primary transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
