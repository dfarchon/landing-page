...
const GetStarted = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Visit the Dark Forest official website, connect your wallet, and choose a suitable game version.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
    ...
    {
      number: 3,
      title: 'Initialize Planet',
      description: 'After connecting your wallet, the system will guide you to initialize your first planet, which will become your starting point in the universe.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
    ...
    },
    {
      number: 4,
      title: 'Learn Basics',
      description: 'Complete the built-in game tutorials to learn how to move, explore, and expand your territory. Master the basic concepts of zkSNARKs.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
    ...
    },
    {
      ...
      description: 'Use various exploration tools to discover new planets, upgrade your fleet through the tech tree, and interact or compete with other players.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
    ...
    },
    {
      ...
      description: 'Communicate with other players through Discord, forums, and social media. Learn advanced strategies and participate in community events.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
  ...
  return (
    <section id="getting-started" className="py-24 relative" ref={sectionRef}>
      {/* Background accent */}
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 inline-block gradient-text">Getting Started</h2>
